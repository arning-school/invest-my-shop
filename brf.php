...
else
{
	...
	if(!mysqli_query($con,"INSERT INTO signup (Name,DoB,who_are_you,Email,phone,Address) VALUES ('$name','$gender','$fathername','$mothername','$address','$city','$postoffice','$pincode','$state','$country','$mobile','$adhar','$pan','$voter','$qualification','$shortbio','$mission','$vision')"))
	{
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Pre-Registration Form For Business Man</h1>
    ...
    <section class="ftco-section contact-section">
        ...
        <div class="row block-9 justify-content-center mb-5">
          <div class="col-md-8 mb-md-5">
          	<h2 class="text-center">PERSONAL INFORMATION OF BUSINESS MAN</h2><b>
            <form action="connectR.php" method="POST" class="bg-light p-5 contact-form">
              <div class="form-group">
                ...
                <div class="form-group">
				<input type="text" class="form-control" placeholder="Enter Your Mother Name" name="mothername"></div>
                <div class="form-group">
				<input type="text" class="form-control" placeholder="Enter Your Date of Birth" name="dob" autocomplete="off"></div>
                <div class="form-group">
				<input type="text" class="form-control" placeholder="Enter Your Full Address" name="address"></div>
                <div class="form-group">
				<input type="text" class="form-control" placeholder="Enter Your City" name="city"></div>
                <div class="form-group">
				<input type="text" class="form-control" placeholder="Enter Your Post Office" name="postoffice"></div>
                <div class="form-group">
				<input type="text" class="form-control" placeholder="Enter Your Pincode" name="pincode"></div>
                <div class="form-group">
				<input type="text" class="form-control" placeholder="Enter Your State" name="state"></div>
                <div class="form-group">
				<input type="text" class="form-control" placeholder="Enter Your Country" name="country"></div>
                <div class="form-group">
				<input type="text" class="form-control" placeholder="Enter Your Mobile No" name="mobile"></div>
                <div class="form-group">
				<input type="text" class="form-control" placeholder="Enter Your Adhar No" name="adhar"></div>
                <div class="form-group">
				<input type="text" class="form-control" placeholder="Enter Your Pan No" name="pan"></div>
                <div class="form-group">
				<input type="text" class="form-control" placeholder="Enter Your Voter Id" name="voter"></div>
                <div class="form-group">
				<input type="text" class="form-control" placeholder="Enter Your Qualification" name="qualification"></div>
                <div class="form-group">
              <div class="form-group">
                <textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="Short Biography कम शब्द; में अपनी पुरी लाइफ जर्नी बताइए" name="shortbio"></textarea></div>
                <div class="form-group">
				<textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="Enter Your Mission आप इस समय अपने जिवन को बेहतर बनाने के लिए क्या कर रहे है, क्यो कर रहे है, कैसे कर रहे है" name="mission"></textarea></div>
                <div class="form-group">
				<textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="Enter Your Vision 10 या 20----50---90 साल बाद आप अपने जीवन को कहॉ लेकर जाएगें मतलब संसार में लोग आप को किस नाम से जानेगें" name="vision"></textarea></div>
              <div class="form-group">
